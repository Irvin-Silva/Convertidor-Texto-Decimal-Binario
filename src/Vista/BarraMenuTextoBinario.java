 ...
 * @author irvin
 */
public class BarraMenuTextoBinario extends JMenuBar implements ActionListener  
{
    //Elementos del menu
    ...
    //Metodo Constructor
    public BarraMenuTextoBinario (VentanaPrincipalTextoBinario ventPrin)
    {
        ...
        Icon iconoSalir = new ImageIcon(getClass().
        getResource("/vista/salir.png"));
        miSalir.setIcon(iconoSalir);
    ...
    public void actionPerformed (ActionEvent e)
    {
        ...
        if(comando.equals("Info"))
        {
            ...
            miVentanaPrincipal.mostrarInfoTextoBinario();
        }
