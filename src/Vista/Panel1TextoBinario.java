 ...
 * @author irvin
 */
public class Panel1TextoBinario extends JPanel implements ActionListener
{
    //Elementos del panel
    ...
    private VentanaPrincipalTextoBinario ventPrin;
    //Metodo constructor
    public Panel1TextoBinario(VentanaPrincipalTextoBinario vp)
    {
        //Contenedor
        setLayout(null);
        ...
        //Texto
        texto= new JLabel("Texto a convertir");
        ...
        btConvertir.setActionCommand("CONVERTIR A BINARIO");
        ...
        SpResultado.setBounds(10, 298, 575, 80);
