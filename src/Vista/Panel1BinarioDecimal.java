 ...
 * @author irvin
 */
public class Panel1BinarioDecimal extends JPanel implements ActionListener
{
    //Elementos del panel
    private JLabel lbimagen;
    private ImageIcon iFondo, iIcon,iFirma;
    private JTextField tBinario,tSbruto;
    ...
    private VentanaPrincipalBinarioDecimal ventPrin;
    //Metodo constructor
    public Panel1BinarioDecimal(VentanaPrincipalBinarioDecimal vp)
    {
        //Contenedor
        setLayout(null);
        ...
        //Texto
        texto= new JLabel("Número binario a convertir");
        ...
        //Botón convertir
        btConvertir=new JButton("CONVERTIR A DECIMAL");
        btConvertir.setBounds(11, 168, 210, 30);
        add(btConvertir);
        btConvertir.setBackground(new java.awt.Color(37, 176, 143));
