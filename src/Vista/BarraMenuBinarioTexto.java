 ...
 * @author irvin
 */
public class BarraMenuBinarioTexto extends JMenuBar implements ActionListener  
{
    //Elementos del menu
    ...
    //Metodo Constructor
    public BarraMenuBinarioTexto (VentanaPrincipalBinarioTexto ventPrin)
    {
        ...
        miCalcular =new JMenuItem("Convertir a texto");
        miCalcular.setActionCommand("Convertir a texto");
    ...
    public void actionPerformed (ActionEvent e)
    {
        ...
        if(comando.equals("Convertir a texto"))
        {
        ...
        if(comando.equals("Info"))
        {
            ...
            miVentanaPrincipal.mostrarInfoBinarioTexto();
        }
    }
}
