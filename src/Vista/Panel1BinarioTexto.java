 ...
 * @author irvin
 */
public class Panel1BinarioTexto extends JPanel implements ActionListener
{
    //Elementos del panel
    ...
    private VentanaPrincipalBinarioTexto ventPrin;
    //Metodo constructor
    public Panel1BinarioTexto(VentanaPrincipalBinarioTexto vp)
    {
        //Contenedor
        setLayout(null);
        ...
        //Botón convertir
        btConvertir=new JButton("CONVERTIR A TEXTO");
        ...
        SpResultado.setBounds(10, 298, 575, 100);
